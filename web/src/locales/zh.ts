export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      namePlaceholder: '请输入名称',
      doc: '文档',
      datasetDescription: '解析文档 -> 配置参数 -> 问答测试',
      addFile: '新增文件',
      searchFiles: '搜索文件',
      localFiles: '本地文件',
      emptyFiles: '新建空文件',
...
General：实体和关系提取提示来自 GitHub - microsoft/graphrag：基于图的模块化检索增强生成 (RAG) 系统`,
    ...
    chat: {
      ...
      tavilyApiKeyMessage: '请输入你的 API Key',
      ...
      unknownApp: '未知应用',
      discovery: '发现',
      noWorkspaceItems: '暂无工作区项目',
      addedToWorkspace: '已添加到工作区',
      render: '渲染',
      renderPage: '渲染页面',
      backToHome: '返回主页',
      pasteIframeCode: 'iframe',
      pasteIframeCodePlaceholder: '请粘贴iframe代码',
      reset: '重置iframe',
      backToEdit: '返回编辑',
